...
◇タスクトレイ常駐時の操作
タスクトレイアイコンを左クリックすると、音量の変更が可能です。
この音量はWindows標準のアプリケーション単位音量に連動しています。
...
●バージョン履歴
2026/05/30 ver.0.6.4.2
・Windows Updateで強制終了されたときに自動再起動するようにした
・音量変更トラックバーの移動量を調整

2026/05/02 ver.0.6.4.1
・Win11アップデートでMIDI INがオープンできなくなる問題を回避
・音量変更に閉じるボタンを足した＆Escで閉じられるようにした

2026/02/14 ver.0.6.4.0
・トレイアイコンのクリックで音量変更できるようにした
・高DPI環境化でのタスクトレイアイコンが変になっていたのを修正
